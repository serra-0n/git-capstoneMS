document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadResortContext() {
    try {
      ...
      document.getElementById("resortAdminName").textContent = fullName || "Resort Administrator";
      document.getElementById("resortAdminWelcome").textContent = `Welcome back, ${context.user.firstName || "Admin"}!`;
